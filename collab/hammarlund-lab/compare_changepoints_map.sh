...
#BSUB -J compare_changepoints_map
#BSUB -e compare_changepoints_map.%J.err
#BSUB -o compare_changepoints_map.%J.out
#BSUB -q normal
...
comparisonbed=${compname}.all.bed
tempbg=${compname}.temp.all.bg
bedgraph=${compname}.all.bg
bigwig=${compname}.all.bw
